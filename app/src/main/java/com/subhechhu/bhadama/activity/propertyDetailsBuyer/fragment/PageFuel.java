...
public class PageFuel extends Fragment {

    private static final String TAG = PageFuel.class.getSimpleName();
    ...
    public static PageFuel newInstance() {
        return new PageFuel();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        poiViewModel.makeGetRequest(GetUrl.POI_PETROLPUMP + position, 7486);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView_title.setText("Petrol Pump");

        textView_title.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_baseline_local_gas_station_24, 0, 0, 0);
