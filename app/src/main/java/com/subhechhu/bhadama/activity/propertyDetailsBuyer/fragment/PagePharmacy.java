...
public class PagePharmacy extends Fragment {

    private static final String TAG = PagePharmacy.class.getSimpleName();
    ...
    public static PagePharmacy newInstance() {
        return new PagePharmacy();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        poiViewModel.makeGetRequest(GetUrl.POI_PHARMACY + position, 7486);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parentView.findViewById(R.id.textView_viewinmap).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (locationArray.length() > 0) {
                    ...
                    Toast.makeText(getActivity(), "No Pharmacy Nearby", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        textView_title.setText("Pharmacy");

        textView_title.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_baseline_local_pharmacy_24, 0, 0, 0);
